...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, LoginFormAuthenticator $authenticator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('josephinemeignan@gmail.com', 'Joséphine'))
                    ->to($user->getEmail())
    ...
    /**
     * @Route("/expert/register", name="expert_app_register")
     */
    public function expertRegister(Request $request, UserPasswordEncoderInterface $passwordEncoder, GuardAuthenticatorHandler $guardHandler, LoginFormAuthenticator $authenticator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $expert->setProfession($form->get('profession')->getData())
                        ->setNumeroSIRET($form->get('numeroSIRET')->getData())
    ...
    /**
     * @Route("expert/verify/email", name="expert_app_verify_email")
     */
    public function verifyExpertEmail(Request $request): Response
